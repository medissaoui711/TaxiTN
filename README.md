# 🚗 TaxiTN / Careem Clone — Full-Stack Frontend SPA
...
**نسخة مستنسخة كاملة من تطبيق كريم — مبنية بـ Vanilla HTML/CSS/JS بدون أي إطار عمل**
...
مشروع استنساخ كامل لتطبيق **كريم** (Careem) — أحد أكبر تطبيقات النقل والتوصيل في منطقة الشرق الأوسط. يشمل المشروع واجهة مستخدم SPA كاملة مع 9 صفحات تفاعلية، ونظام خرائط مبني باستخدام Leaflet.js.
...
| **Pay** | محفظة كريم باي + إرسال أموال |
